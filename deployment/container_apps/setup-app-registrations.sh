...
echo ""
echo "   # Activity UI (deploy.sh uses this for EasyAuth + redirect URI)"
echo "   ACTIVITY_UI_CLIENT_ID=$UI_APP_ID"
echo ""
echo "   # Activity UI (MCP servers use this to acquire tokens for event publishing)"
