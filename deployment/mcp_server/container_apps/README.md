...
# 3. Copy the ACA_* values printed by setup.sh into the repo-root .env.server file.
#    deploy.sh reads infrastructure config (ACR, environment, identity) from
#    .env.server and passes it to Bicep — do NOT duplicate these in .bicepparam files.
