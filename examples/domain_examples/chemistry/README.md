...
This example uses `create_noop_auth_config()` (no authentication required). For production deployments with Entra ID, see the [deployment guide](../../../docs/guide/deploying.md).
