...
clip_to_geometry = ToolDefinition(
    ...
    return_spec=[
        ...
        ReturnSpec(name="bounds", type=list, description="Bounds of the clipped raster in the clipped raster CRS."),
        ReturnSpec(name="input_bbox_4326", type=list, description="Union bbox of input geometries in EPSG:4326."),
