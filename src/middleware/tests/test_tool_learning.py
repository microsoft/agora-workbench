...
from middleware.tool_learning.middleware_function import _check_hard_violations
...
class TestExtractToolNames:
    ...
    def test_extracts_from_default_options(self):
        from middleware.tool_learning.middleware_run import _extract_tool_names
...
class TestVignetteRunMiddlewareProcess:
    ...
    def _make_middleware(self, search_repo=None, **kwargs):
        ...
        from middleware.tool_learning.middleware_run import VignetteRunMiddleware
