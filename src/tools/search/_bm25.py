...
This module is intentionally framework-agnostic so that domain-specific
search backends (e.g. tool search, vignette search) can share the core
ranking implementation.

Example::

    from tools.search._bm25 import BM25Index, tokenize

    index: BM25Index[str] = BM25Index()
    index.add("doc-1", "the quick brown fox")
    index.add("doc-2", "lazy dog sleeps")

    for doc_id, score in index.search("quick fox"):
        print(doc_id, score)
"""
