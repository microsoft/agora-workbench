...
def create_toolmaker_function(
    ...
    async def create_tool_from_repo(
        ...
        LOGGER.warning("ToolMaker is not available: the toolmaker package has been removed.")
        return (
            "Tool creation is not available: the ToolMaker package has been removed. "
            "Use a HelpResponse to inform the user."
        )
