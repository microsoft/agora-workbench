...
from toolmaker.tools.repo_tools import (
    create_repo_tools,
    _safe_path,
)
...
class TestSafePath:
    def test_normal_path(self, tmp_path):
        with patch("toolmaker.tools.repo_tools._TOOLMAKER_WORKSPACE", tmp_path):
...
class TestRepoTools:
    ...
    async def test_read_repo_file(self, mock_repo):
        with patch("toolmaker.tools.repo_tools._TOOLMAKER_WORKSPACE", mock_repo.parent):
