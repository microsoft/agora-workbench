...
from plan_then_execute.executors import (
    HelpHandlerExecutor,
    PlanningHelpHandlerExecutor,
    PresentationHelpHandlerExecutor,
    BaseLLMExecutor,
)
from plan_then_execute.plan import Plan
from plan_then_execute.response_models import (
    AgentResponse,
    HelpResponse,
    SolutionResponse,
)
from plan_then_execute.prompts.renderer import (
...
class TestAgentAutopilot:
    ...
    def test_default_agent_not_autopilot(self, mock_environment_variables):
        with (
            patch("plan_then_execute.agent.AzureOpenAIChatClient") as mock_cls,
