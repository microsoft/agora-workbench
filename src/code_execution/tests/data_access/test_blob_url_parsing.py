...
def mock_obo_provider(create_mock_obo_provider):
    """Provide a mock OBO provider for tests."""
...
class TestBlobURLParsingValidation:
    ...
    def test_valid_abfss_url(self, mock_obo_provider):
    ...
    def test_valid_https_url(self, mock_obo_provider):
    ...
    def test_https_url_without_blob_path(self, mock_obo_provider):
    ...
    def test_parse_abfss_with_nested_path(self, mock_obo_provider):
    ...
    def test_parse_url_with_special_characters(self, mock_obo_provider):
    ...
    def test_abfss_missing_at_symbol(self, mock_obo_provider):
    ...
    def test_abfss_empty_container(self, mock_obo_provider):
    ...
    def test_abfss_empty_storage_account(self, mock_obo_provider):
    ...
    def test_abfss_malformed_domain(self, mock_obo_provider):
    ...
    def test_abfss_multiple_at_symbols(self, mock_obo_provider):
    ...
    def test_https_empty_netloc(self, mock_obo_provider):
    ...
    def test_https_missing_container(self, mock_obo_provider):
    ...
    def test_https_no_path(self, mock_obo_provider):
    ...
    def test_unsupported_protocol(self, mock_obo_provider):
    ...
    def test_abfss_no_domain_extension(self, mock_obo_provider):
    ...
    def test_can_handle_valid_abfss(self, mock_obo_provider):
    ...
    def test_can_handle_valid_https_blob(self, mock_obo_provider):
    ...
    def test_can_handle_valid_https_dfs(self, mock_obo_provider):
    ...
    def test_can_handle_rejects_non_azure(self, mock_obo_provider):
