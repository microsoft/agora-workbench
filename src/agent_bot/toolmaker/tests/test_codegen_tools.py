...
from agent_bot.toolmaker.models import TaskSpec
from agent_bot.toolmaker.tools.codegen_tools import (
...
class TestSafeDomainPath:
    def test_traversal_rejected(self, tmp_path):
        with patch("agent_bot.toolmaker.tools.codegen_tools._AGORA_MAF_ROOT", tmp_path):
...
class TestCodegenTools:
    ...
    async def test_write_and_read(self, domain_root):
        task_spec = TaskSpec()
        with patch("agent_bot.toolmaker.tools.codegen_tools._AGORA_MAF_ROOT", domain_root):
