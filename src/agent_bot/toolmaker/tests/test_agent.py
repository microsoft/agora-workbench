...
from agent_bot.toolmaker.models import TaskSpec, ImplementationState, ToolPersistence
from agent_bot.toolmaker.executors import (
...
from agent_bot.toolmaker.prompts.renderer import (
...
class TestToolMakerAgentConstruction:
    ...
    @patch("agent_bot.toolmaker.agent.ToolMakerAgent._create_chat_client")
    def test_agent_init(self, mock_create_client):
        mock_create_client.return_value = MagicMock()
        from agent_bot.toolmaker.agent import ToolMakerAgent
